...
<div class="display-area d-flex flex-wrap justify-content-center">
    ...
    <div class="card h-50 position-relative">
        <img src="https://www.tasteofhome.com/wp-content/uploads/2021/01/Blueberry-Mint-Frozen-Margarita_EXPS_TOHX25_257585_DR_01_23_1b.jpg" class="card-img-top" alt="Margarita">
        ...
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Margarita">
            <input type="hidden" name="price" value="8.00">
            <input type="hidden" name="imageUrl" value="https://www.tasteofhome.com/wp-content/uploads/2021/01/Blueberry-Mint-Frozen-Margarita_EXPS_TOHX25_257585_DR_01_23_1b.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Margarita</h5>
            <p class="card-text">Tequila, triple sec, and fresh lime juice shaken and served with a salted rim.</p><br>
    ...
    <div class="card h-50 position-relative">
        ...
        <div class="card-body d-flex flex-column">
            ...
            <p class="card-text">White rum, fresh lime juice, sugar, soda water, and mint leaves for a refreshing taste.</p><br>
    ...
    <div class="card h-50 position-relative">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3YD3nicjRu4LR05hEtwBUpVAujgf6EC4uIw&s" alt="Cosmopolitan" class="card-img-top" />
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1" title="Add to Favorites"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Cosmopolitan" />
            <input type="hidden" name="price" value="8.50" />
            <input type="hidden" name="imageUrl" value="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3YD3nicjRu4LR05hEtwBUpVAujgf6EC4uIw&s" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Cosmopolitan</h5>
            <p class="card-text">Vodka, triple sec, cranberry juice, and fresh lime juice shaken and strained.</p><br>
    ...
    <!-- Cocktail 4: Bloody Mary -->
    <div class="card h-50 position-relative">
        <img src="https://images.immediate.co.uk/production/volatile/sites/30/2020/08/bloody-mary-a2983ba.jpg" alt="Bloody Mary" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1" title="Add to Favorites"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Bloody Mary" />
            <input type="hidden" name="price" value="7.00" />
            <input type="hidden" name="imageUrl" value="https://images.immediate.co.uk/production/volatile/sites/30/2020/08/bloody-mary-a2983ba.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Bloody Mary</h5>
            <p class="card-text">Vodka mixed with tomato juice, Worcestershire sauce, lemon juice, and spices.</p><br>
    ...
    <!-- Cocktail 5: Daiquiri -->
    <div class="card h-50 position-relative">
        <img src="https://creative-culinary.com/wp-content/uploads/raspberry-daiquiri1-Rev1.jpg" alt="Daiquiri" class="card-img-top" />
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1" title="Add to Favorites"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Daiquiri" />
            <input type="hidden" name="price" value="7.25" />
            <input type="hidden" name="imageUrl" value="https://creative-culinary.com/wp-content/uploads/raspberry-daiquiri1-Rev1.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Daiquiri</h5>
            <p class="card-text">White rum shaken with lime juice and simple syrup, served chilled.</p><br>
    ...
    <!-- Cocktail 6: Martini -->
    <div class="card h-50 position-relative">
        <img src="https://www.tasty-lowcarb.com/wp-content/uploads/2019/09/Vertical-Two-Glass-Full-Set-Close-f13-198.jpg" alt="Martini" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Martini" />
            <input type="hidden" name="price" value="8.50" />
            <input type="hidden" name="imageUrl" value="https://www.tasty-lowcarb.com/wp-content/uploads/2019/09/Vertical-Two-Glass-Full-Set-Close-f13-198.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Martini</h5>
            <p class="card-text">Gin or vodka with vermouth, stirred or shaken, garnished with an olive or lemon twist.</p><br>
            <p class="card-text"><strong>Price: $8.50</strong></p>
            <form action="${pageContext.request.contextPath}/AddToCart" method="post" class="d-flex align-items-center gap-2">
                <input type="hidden" name="productName" value="Martini" />
                <input type="hidden" name="price" value="8.50" />
    ...
    <!-- Cocktail 7: Old Fashioned -->
    <div class="card h-50 position-relative">
        <img src="https://www.redemptionwhiskey.com/wp-content/uploads/2020/12/Old-Fashioned-Main-1.jpg" alt="Old Fashioned" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Old Fashioned" />
            <input type="hidden" name="price" value="9.00" />
            <input type="hidden" name="imageUrl" value="https://www.redemptionwhiskey.com/wp-content/uploads/2020/12/Old-Fashioned-Main-1.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Old Fashioned</h5>
            <p class="card-text">Whiskey-based cocktail with sugar and bitters, garnished with orange peel.</p><br>
    ...
    <!-- Cocktail 8: Moscow Mule -->
    <div class="card h-50 position-relative">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjTWZBF02v34lN0ohoOWJDweHuyMtnxub25g&s" alt="Moscow Mule" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Moscow Mule" />
            <input type="hidden" name="price" value="8.00" />
            <input type="hidden" name="imageUrl" value="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjTWZBF02v34lN0ohoOWJDweHuyMtnxub25g&s" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Moscow Mule</h5>
            <p class="card-text">Vodka, ginger beer, and fresh lime juice served over ice in a copper mug.</p><br>
            <p class="card-text"><strong>Price: $8.00</strong></p>
            <form action="${pageContext.request.contextPath}/AddToCart" method="post" class="d-flex align-items-center gap-2">
                <input type="hidden" name="productName" value="Moscow Mule" />
                <input type="hidden" name="price" value="8.00" />
    ...
    <div class="card h-50 position-relative">
        <img src="https://creative-culinary.com/wp-content/uploads/whisky-sour-2.jpg" alt="Whiskey Sour" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Lemon Sour" />
            <input type="hidden" name="price" value="8.50" />
            <input type="hidden" name="imageUrl" value="https://creative-culinary.com/wp-content/uploads/whisky-sour-2.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Lemon Sour</h5>
            <p class="card-text">Whiskey, lemon juice, sugar, and egg white shaken and served on the rocks.</p><br>
            <p class="card-text"><strong>Price: $8.50</strong></p>
            <form action="${pageContext.request.contextPath}/AddToCart" method="post" class="d-flex align-items-center gap-2">
                <input type="hidden" name="productName" value="Lemon Sour" />
                <input type="hidden" name="price" value="8.50" />
    ...
    <!-- Cocktail 10: Pina Colada -->
    <div class="card h-50 position-relative">
        <img src="https://www.1800tequila.com/wp-content/uploads/2021/10/C-jalisco-colada@2x.jpg" alt="Pina Colada" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Pina Colada" />
            <input type="hidden" name="price" value="8.75" />
            <input type="hidden" name="imageUrl" value="https://www.1800tequila.com/wp-content/uploads/2021/10/C-jalisco-colada@2x.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Pina Colada</h5>
            <p class="card-text">Rum, coconut cream, and pineapple juice blended with ice, garnished with pineapple slice.</p>
    ...
    <!-- Cocktail 11: Negroni -->
    <div class="card h-50 position-relative">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtWnGLTnEDNcUkVzwwUzWKWNTkoH6KqcBBSQ&s" alt="Negroni" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Negroni" />
            <input type="hidden" name="price" value="8.00" />
            <input type="hidden" name="imageUrl" value="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtWnGLTnEDNcUkVzwwUzWKWNTkoH6KqcBBSQ&s" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Negroni</h5>
            <p class="card-text">Gin, Campari, and sweet vermouth, stirred and served on the rocks with orange peel.</p>
            <p class="card-text"><strong>Price: $8.00</strong></p>
            <form action="${pageContext.request.contextPath}/AddToCart" method="post" class="d-flex align-items-center gap-2">
                <input type="hidden" name="productName" value="Negroni" />
                <input type="hidden" name="price" value="8.00" />
    ...
    <!-- Cocktail 12: French 75 -->
    <div class="card h-50 position-relative">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQWlff_YHs9eMF52iZjeTtd_7TQnVn7Rpueg&s" alt="French 75" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="French 75" />
            <input type="hidden" name="price" value="9.00" />
            <input type="hidden" name="imageUrl" value="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQWlff_YHs9eMF52iZjeTtd_7TQnVn7Rpueg&s" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">French 75</h5>
            <p class="card-text">Gin, lemon juice, sugar syrup, and champagne served in a flute.</p><br>
            <p class="card-text"><strong>Price: $9.00</strong></p>
            <form action="${pageContext.request.contextPath}/AddToCart" method="post" class="d-flex align-items-center gap-2">
                <input type="hidden" name="productName" value="French 75" />
                <input type="hidden" name="price" value="9.00" />
    ...
    <!-- Cocktail 13: Aperol Spritz -->
    <div class="card h-50 position-relative">
        <img src="https://www.acouplecooks.com/wp-content/uploads/2020/05/Aperol-Spritz-020.jpg" alt="Aperol Spritz" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Aperol Spritz" />
            <input type="hidden" name="price" value="9.00" />
            <input type="hidden" name="imageUrl" value="https://www.acouplecooks.com/wp-content/uploads/2020/05/Aperol-Spritz-020.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Aperol Spritz</h5>
            <p class="card-text">Prosecco, Aperol, and soda water served with an orange slice.</p><br>
            <p class="card-text"><strong>Price: $9.00</strong></p>
            <form action="${pageContext.request.contextPath}/AddToCart" method="post" class="d-flex align-items-center gap-2">
                <input type="hidden" name="productName" value="Aperol Spritz" />
                <input type="hidden" name="price" value="9.00" />
    ...
    <!-- Cocktail 14: Whiskey Sour -->
    <div class="card h-50 position-relative">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMeYLPZImgvcT3RUXNbAnnf8SiHcJy91c91g&s" alt="Whiskey Sour" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Whiskey Sour" />
            <input type="hidden" name="price" value="8.50" />
            <input type="hidden" name="imageUrl" value="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMeYLPZImgvcT3RUXNbAnnf8SiHcJy91c91g&s" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Whiskey Sour</h5>
            <p class="card-text">Whiskey, lemon juice, sugar, and a frothy egg white top for a classic sour flavor.</p><br>
            <p class="card-text"><strong>Price: $8.50</strong></p>
            <form action="${pageContext.request.contextPath}/AddToCart" method="post" class="d-flex align-items-center gap-2">
                <input type="hidden" name="productName" value="Whiskey Sour" />
                <input type="hidden" name="price" value="8.50" />
    ...
    <!-- Cocktail 15: Espresso Martini -->
    <div class="card h-50 position-relative">
        <img src="https://filodeagave.com/wp-content/uploads/2024/08/Tequila-Espresso-Martini-Cocktail-Recipe-v002.jpg" alt="Espresso Martini" class="card-img-top"/>
        <button type="button" class="btn btn-favorite position-absolute top-0 end-0 m-1 p-1"><i class="fa fa-heart"></i></button>
        <form action="${pageContext.request.contextPath}/AddToFavorites" method="post" class="favorite-form d-none">
            <input type="hidden" name="productName" value="Espresso Martini" />
            <input type="hidden" name="price" value="9.00" />
            <input type="hidden" name="imageUrl" value="https://filodeagave.com/wp-content/uploads/2024/08/Tequila-Espresso-Martini-Cocktail-Recipe-v002.jpg" />
            <input type="hidden" name="action" value="add" />
        </form>
        <div class="card-body d-flex flex-column">
            <h5 class="card-title">Espresso Martini</h5>
            <p class="card-text">Vodka, coffee liqueur, and fresh espresso shaken into a rich and creamy cocktail.</p><br>
            <p class="card-text"><strong>Price: $9.00</strong></p>
            <form action="${pageContext.request.contextPath}/AddToCart" method="post" class="d-flex align-items-center gap-2">
                <input type="hidden" name="productName" value="Espresso Martini" />
                <input type="hidden" name="price" value="9.00" />
